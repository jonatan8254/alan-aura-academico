...
| ID | Pantalla | Ruta | CU · RF | Actor | Prioridad | Estados clave |
|---|---|---|---|---|---|---|
| P-01 | Presentación / landing | `/` | CU-01 · RF-19 | Visitante | Alta | default · servicio no disponible |
| P-02 | Registro | `/registro/` | CU-02 · RF-20 | Visitante | Alta | vacío · error 400 · username en uso |
| P-03 | Iniciar sesión (usuario) | `/login/` | CU-03 · RF-21 | Usuario | Alta | vacío · credenciales inválidas |
| P-04 | Iniciar sesión (admin, separado) | `/plataforma-admin/login/` | CU-03 · RF-14 | Administrador | Media | vacío · 403 rol insuficiente |
| P-13 | Gestión de cuenta y datos | `/cuenta/…` | CU-04 · RF-22/23/24 | Usuario | Media | default · confirmar eliminación (destructivo) |

### Paquete B · Acompañamiento
| ID | Pantalla | Ruta | CU · RF | Actor | Prioridad | Estados clave |
|---|---|---|---|---|---|---|
| P-05 | Onboarding · disclosure de IA | `/onboarding/` | CU-05 · RF-01 | Usuario | Alta | default (precede a todo dato) |
| P-06 | Onboarding · declaración de edad | `/onboarding/` | CU-05 · RF-02 | Usuario | Alta | default · **bloqueo <18** |
| P-07 | Onboarding · consentimiento granular | `/onboarding/` | CU-05 · RF-03 | Usuario | Alta | toggles apagados · revocar |
| P-08 | Onboarding · caracterización (5 preguntas → `ContextoInicialConversacionalV1`) | `/onboarding/` | CU-05 · RF-04/05 | Usuario | Alta | completo · parcial/omitir (todo opcional salvo personaje) |
| P-09 | Onboarding · elegir Alan o Aura | `/onboarding/` | CU-05 · RF-06 | Usuario | Alta | comparar · seleccionado |
| P-10 | Chat con el acompañante (normal) | `/api/chat/` | CU-06 · RF-07…13/25 | Usuario · LLM | Alta | vacío/bienvenida · escribiendo · límite de sesión · cambiar personaje |
| P-11 | Chat · error/degradación | `/api/chat/` | CU-06 · RF-26 | Sistema | Media | 401/403/400/409/429/502/504 (sin códigos crudos) |
| P-12 | Contención + derivación (safety fallback) | (respuesta `safety_fallback`) | CU-07 · RF-11 | Usuario (disparo del sistema) | Alta | contención + recursos + nueva sesión |

### Paquete C · Administración de plataforma
| ID | Pantalla | Ruta | CU · RF | Actor | Prioridad | Estados clave |
|---|---|---|---|---|---|---|
| P-14 | Directorio de usuarios | `/plataforma-admin/` | CU-08 · RF-15 | Administrador | Media | lista truncada · vacío · 401/403 |
| P-15 | Métricas de uso (agregadas) | `/plataforma-admin/` | CU-09 · RF-16 | Administrador | Media | agregados · sin datos por usuario |
| P-16 | Kill switch (habilitar/deshabilitar) | `/plataforma-admin/chat-access/` | CU-10 · RF-17/18 | Administrador | Alta | habilitado · deshabilitado · **modal de confirmación** + auditoría |
