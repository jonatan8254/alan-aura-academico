...
**ID documento:** DOC-CU-08 · **Caso de uso:** CU-08 · **Alias en DCU-01:** `CU_Dir` · **Familia:** ECU (especificación de casos de uso, fase 2 ICONIX) · **Hogar:** `docs/07_casos_uso/especificaciones/` · **Fecha:** 2026-07-31 · **Versión:** v2.1 (`CDR-01` `H-17`: `RE-04` exigía que la vista «no permita señalar a una persona concreta», incumplible en un directorio donde cada fila **es** un titular — reformulada a no exponer dato sensible). v2.0 (PDR-01, fase D.3, tanda 4) · **Estado:** Propuesto.
