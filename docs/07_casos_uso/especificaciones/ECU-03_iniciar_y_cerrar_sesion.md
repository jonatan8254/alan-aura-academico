...
**ID documento:** DOC-CU-03 · **Caso de uso:** CU-03 · **Alias en DCU-01:** `CU_Login` · **Familia:** ECU (especificación de casos de uso, fase 2 ICONIX) · **Hogar:** `docs/07_casos_uso/especificaciones/` · **Fecha:** 2026-07-31 · **Versión:** v2.0 · **Estado:** Propuesto.
