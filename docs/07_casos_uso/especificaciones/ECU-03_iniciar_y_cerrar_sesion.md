...
**ID documento:** DOC-CU-03 · **Caso de uso:** CU-03 · **Alias en DCU-01:** `CU_Login` · **Familia:** ECU (especificación de casos de uso, fase 2 ICONIX) · **Hogar:** `docs/07_casos_uso/especificaciones/` · **Fecha:** 2026-07-31 · **Versión:** v2.2 (`SD-44` (`TVI-06`): la fila de `SD-42` publicaba «23 descendentes / 3 / 5» **como hecho**, y la cifra real es **21 / 3 / 7**. Se tacha y se rectifica, no se borra (`SD-31`). **Ninguna afirmación vigente de este artefacto cambia.**). v2.1 (SD-42: historial reordenado a descendente; ninguna afirmación cambia). v2.0 · **Estado:** Propuesto.
