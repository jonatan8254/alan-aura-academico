...
**ID documento:** DOC-CU-02 · **Caso de uso:** CU-02 · **Alias en DCU-01:** `CU_Reg` · **Familia:** ECU (especificación de casos de uso, fase 2 ICONIX) · **Hogar:** `docs/07_casos_uso/especificaciones/` · **Fecha:** 2026-07-31 · **Versión:** v2.1 (SD-42: historial reordenado a descendente; ninguna afirmación cambia). v2.0 · **Estado:** Propuesto.
