...
**ID:** CP-05 · **Familia:** CP (pruebas derivadas de secuencia, fase 2 ICONIX) · **Hogar:** `docs/07_casos_uso/secuencia/pruebas/` · **Fecha:** 2026-08-01 · **Versión:** v1.0 · **Estado:** Propuesto.
...
| CP-208 | `C_SolicitarReingreso` | **FE-04** | Onboarding en curso (P-07 o P-08). | La sesión expira antes de confirmar. | HTTP 401; redirige a P-03; **nada de lo no confirmado quedó escrito**. | CA-10 |
