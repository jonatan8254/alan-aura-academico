...
**ID:** CP-09 · **Familia:** CP · **Hogar:** `docs/07_casos_uso/secuencia/pruebas/` · **Fecha:** 2026-08-01 · **Versión:** v1.0 · **Estado:** Propuesto.
**Insumos:** `DR-09 v2.0` (8 controladores), `DS-09 v1.0`, `ECU-09 v2.0` (`CA-01…CA-09`), `PRIV-01` (`PRIV-R10`), `MV-01` `RN-03.3`/`RN-03.5`, `REQ-01` (`RC-07`, `MET-07`).
...
| CP-1004 | `C_CalcularAgregados` | Básico p.1 · **FA-01 no tomado** | La ventana de siete días tiene eventos registrados. | El sistema calcula. | Presenta total de cuentas, onboardings completados y llamadas al chat de los últimos 7 días, como cifras del **grupo único «plataforma completa»**. | CA-01 |
