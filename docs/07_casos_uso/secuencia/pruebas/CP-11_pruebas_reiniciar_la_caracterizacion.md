...
**ID:** CP-11 · **Familia:** CP · **Hogar:** `docs/07_casos_uso/secuencia/pruebas/` · **Fecha:** 2026-08-01 · **Versión:** v1.0 · **Estado:** Propuesto.
...
| CP-1207 | `C_MsgPeticionInvalida` | **FE-03** | Advertencia mostrada. | Llega la petición **sin la confirmación explícita** exigida, o mal formada. | HTTP 400; **ningún registro de cápsula desaparece**; vuelve al paso 1 y puede confirmar de nuevo. | CA-10 |
...
| CP-1210 | `C_DeshacerBorrado` | **FE-04** | Borrado en curso. | El sistema no logra completarlo (fallo inducido). | HTTP 500; una inspección inmediata muestra la cápsula **completa, con `character`, sin campos parciales ni ausentes**; vuelve al paso 1. | CA-11 |
