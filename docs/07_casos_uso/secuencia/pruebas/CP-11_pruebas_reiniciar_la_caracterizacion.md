...
**ID:** CP-11 · **Familia:** CP · **Hogar:** `docs/07_casos_uso/secuencia/pruebas/` · **Fecha:** 2026-08-01 · **Versión:** v1.1 (SD-41: `CP-1210` deja de verificar una reversión que `H-15` declaró **innecesaria** y pasa a verificar que el fallo se informa **sin haber suprimido nada** — `VI-02`). v1.0 · **Estado:** Propuesto.
