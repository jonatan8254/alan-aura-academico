...
**ID:** CP-10 · **Familia:** CP · **Hogar:** `docs/07_casos_uso/secuencia/pruebas/` · **Fecha:** 2026-08-01 · **Versión:** v1.2 · **Estado:** Propuesto.
...
| CP-1108 | `C_CancelarCambio` | **FA-02** | Diálogo abierto. | Pulsa «Cancelar». | Vuelve a P-16; el estado queda intacto; **ninguna `AccionAdministrativa` nueva**; vuelve al **paso 1** (`ECU-10 FA-02`: «Cancela y vuelve al paso 1»). | CA-05 |
...
|---|---|---|---|
| v1.2 | 2026-08-05 | J. Sánchez | `CVI-03` del `CDR-01 v1.7`: `CP-1108` fija el retorno al **paso 1** que declara `ECU-10 FA-02`. |
