# MV-01 — Modelo verbal del MVP «Alan & Aura Académico» (consolidado, apto para extracción de dominio)
**ID:** MV-01 · **Familia:** MV (único) · **Hogar:** `docs/02_modelos_verbales/` · **Fecha:** 2026-07-12 · **Versión:** externa v2.2 / interna v2.2.0 · **Autoría:** Jonatan E. Sánchez Vargas (subproyecto).
...
**Estándar de cumplimiento:** E8 — **11 rasgos {1, 2, 3, 6, 7, 12, 13, 14, 15, 16, 17}**; checklist en §Checklist.
