...
| H-31 | *Endpoints* de la tabla de `ARQ-01` | **13**, bajo el espacio de nombres `/api/v1/` | `ARQ-01-D3` | `REGISTRO_DECISIONES` (`SD-50`), `CHANGELOG` |
