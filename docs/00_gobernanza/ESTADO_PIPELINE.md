...
| 21 | **`VI-03` — `ECU-08` conserva tres sobrepromesas** | Moderado. `RE-04` quedó bien corregido, pero `:32`, `:92` y `:147` siguen diciendo que el directorio «no permite señalar a una persona», que es justo lo que `H-17` reconoció falso | `/use-case-specifier` | No bloquea | `CDR-01 §8-quinquies` |
...
>
> **El recuento, contado sobre las filas y no estimado.** La tabla tiene **22** filas: **9 cerradas**
> (1, 2, 3, 12, 13, 14, 15 y ahora **19 y 20**), **10 abiertas** (4–11, 21 y 22) y **3 declaradas sin acción
> inmediata** (16, 17, 18), que no cuentan como trabajo abierto. *(La nota de `SD-37` decía «once abiertos» y
...
>
> **Los dos Mayores del CDR están cerrados** (`SD-41`). La fila 15 cerró la verificación independiente y abrió
> 19, 20 y 21; de esas, las dos **Mayores** —las que tocaban **comportamiento**— ya no están abiertas: `VI-01`
> dejó de tener ramas que caen al flujo de éxito y `VI-02` completó la costura ICONIX. **Queda `VI-03`**
> (fila 21, Moderado, `ECU-08`) y los huecos del instrumental (fila 22).
>
