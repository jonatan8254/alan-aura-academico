...
**Propósito:** decir en qué fase está el subproyecto y qué sigue. Es el primer archivo a leer al rehidratar contexto. **Fecha de creación:** 2026-07-12 · **Última actualización:** 2026-08-01 · **Versión:** v1.6 (SD-30 completo: los 14 diagramas de secuencia `DS-01…DS-14`, sus 181 casos de prueba y los 7 hallazgos aplicados; robustez queda en **262 elementos** y 150 controladores). v1.4 corrigió el conteo de `.puml` de la Fase 2: son **16**, no 17.
...
1. **Diagrama de clases de diseño** (siguiente artefacto ICONIX): la skill `uml-design-class-model` consume directamente `DOP-01`, que ya trae las **192 operaciones** con su clase receptora y su justificación. Es el artefacto que fija **tipos y firmas** —y por eso `COD-01` se difirió hasta él: escribir firmas antes sería inventarlas.
   ...
   > **Recomendación antes del CDR:** regenerar `MD-01.svg` y `DCU-01.svg` con la retícula corregida. El diagnóstico completo está en `DS-00 §11`. Llegar al CDR con diagramas ilegibles convierte una revisión de fondo en una discusión de forma.
