...
- **Fase 2 (ICONIX) — completa salvo la compuerta:** producidos el modelo de dominio (`MD-01`), el diagrama de casos de uso (`DCU-01`), la especificación textual (`ECU-00…ECU-14`), el análisis de robustez (`DR-00…DR-14`), la compuerta `RPD-01`, los **diagramas de secuencia** (`DS-00…DS-14`, SD-30) con el delta de **193 operaciones** (`DOP-01`) y 181 casos de prueba, y el **modelo de clases de diseño** (`MC-00`/`MC-01`/`COD-01`, SD-32, retrabajado en SD-39): **43 clases** —16 del problema con nombre idéntico a `MD-01` y **27 del espacio de la solución**—, **201 operaciones**, **51 atributos**, 11 enumerados y **80 relaciones**.
