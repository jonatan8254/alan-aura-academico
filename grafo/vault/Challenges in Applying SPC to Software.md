...
# Challenges in Applying SPC to Software
...
## Connections
- [[Correlation vs Causality]] - `references` [EXTRACTED]
- [[Process vs Project Measurements]] - `references` [EXTRACTED]
- [[Statistical Process Control (SPC)]] - `references` [EXTRACTED]
- [[XmR Chart]] - `references` [EXTRACTED]
