...
type: "concept"
community: "Cost & Earned Value Management"
tags:
  - graphify/concept
  - graphify/EXTRACTED
  - community/Cost__Earned_Value_Management
...
## Connections
- [[Cost Controlling]] - `references` [EXTRACTED]
- [[Cost Performance Index (CPI)]] - `references` [EXTRACTED]
- [[Cost Variance  CPI]] - `references` [EXTRACTED]
- [[Earned Value Analysis (control de proyectos)]] - `references` [EXTRACTED]
- [[Global Software Engineering (GSE)]] - `references` [EXTRACTED]
- [[Product and Release Management]] - `references` [EXTRACTED]
- [[Requirements Engineering]] - `conceptually_related_to` [INFERRED]
- [[Schedule Performance Index (SPI)]] - `references` [EXTRACTED]
- [[Schedule Variance  SPI]] - `references` [EXTRACTED]

#graphify/concept #graphify/EXTRACTED #community/Cost__Earned_Value_Management