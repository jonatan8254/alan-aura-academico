...
# CAME Approach (planificación holística de la medición)
...
## Connections
- [[CAME Tools]] - `references` [EXTRACTED]
- [[Reiner R. Dumke]] - `references` [INFERRED]
- [[Software Measurement Establish–Extract–Evaluate–Execute (Ebert & Dumke)]] - `references` [EXTRACTED]
