---
source_file: "The_goal_question_metric_method_p151_visual_asset_63_11_4_data_collection.png"
type: "image"
...
## Connections
- [[Figure 11.4 — Project C MSS Data Flow Manual Forms → Electronic DB Forms → Metrics Base → Analysis Sheets → Presentation Slides]] - `conceptually_related_to` [INFERRED]
- [[Measurement Support System (MSS)_2]] - `references` [INFERRED]

#graphify/image #graphify/INFERRED #community/MSS_Data_Flow