...
## Connections
- [[Challenges in Applying SPC to Software]] - `references` [EXTRACTED]
- [[Control Chart]] - `references` [EXTRACTED]
- [[Controlled Experiment]] - `conceptually_related_to` [INFERRED]
- [[Quantitative Management]] - `references` [EXTRACTED]
- [[Shotgun Correlation Approach]] - `conceptually_related_to` [INFERRED]
- [[Six Sigma  DMAIC]] - `references` [EXTRACTED]

#graphify/concept #graphify/EXTRACTED #community/Statistical_Process_Control