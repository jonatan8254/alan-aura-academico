...
# Tarjeta de contención + derivación (crisis)
...
## Connections
- [[Biblioteca de componentes]] - `references` [EXTRACTED]
- [[P-12 Contención + derivación (safety fallback)]] - `conceptually_related_to` [INFERRED]

#graphify/concept #graphify/INFERRED #community/MVP_UI_Mockups